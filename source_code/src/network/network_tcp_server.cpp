...
//////////////////////////////////////
void NetworkServerTCP::serverMainLoop()
{   
    while(true)
    {
...
//////////////////////////////////////
void NetworkServerTCP::clientHandle_receiver(SOCKET clientSenderSocket, sockaddr_in clientSenderAddress)
{
    // ######################################################################################
    // Start Client Handle
    // ######################################################################################
...
//////////////////////////////////////
void NetworkServerTCP::clientHandle_sender(int setPlayer, sockaddr_in clientSenderAddress)
{
